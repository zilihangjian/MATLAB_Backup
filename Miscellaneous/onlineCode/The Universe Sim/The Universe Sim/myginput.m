...
%%%%%%%%%%%% http://www.mathworks.com/matlabcentral/fileexchange/12770-myginput
%Please note that we did not write this.  This function has the exact same
%function as the ginput function but it allows us to define the type of
%pointer because the default crosshairs do not show up on a black
%background
