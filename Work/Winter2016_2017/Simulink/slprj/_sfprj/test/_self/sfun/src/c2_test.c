...
static const char * c2_debug_family_names[4] = { "nargin", "nargout", "input",
  "output" };
...
static real_T c2_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
  mxArray *c2_b_output, const char_T *c2_identifier);
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = *chartInstance->c2_output;
  ...
  mxArray *c2_st)
{
  ...
  *chartInstance->c2_output = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("output", c2_u, 0)), "output");
  chartInstance->c2_is_active_c2_test = c2_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c2_test", c2_u, 1)),
    "is_active_c2_test");
  sf_mex_destroy(&c2_u);
...
static void sf_gateway_c2_test(SFc2_testInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_input, 2U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_output, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "plot", 0U, 1U, 14, c2_y);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 5);
  c2_b_output = c2_b_input;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -5);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c2_output = c2_b_output;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_testMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_output, 1U, 1U, 0U,
                        chartInstance->c2_sfEvent, false);
}
...
static void init_simulink_io_address(SFc2_testInstanceStruct *chartInstance)
{
  chartInstance->c2_input = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_output = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2141193566U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3790974127U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2965175561U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(356564787U);
}
...
mxArray *sf_c2_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("otgUWaxSPX8dgFGNW9rE0B");
...
static const mxArray *sf_get_sim_state_info_c2_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"output\",},{M[8],M[0],T\"is_active_c2_test\",}}"
  };
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c2_input);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_output);
      }
    }
  }
}
...
{
  return "sugOY0CTpsVvCONlQIhUsVE";
}
...
static void sf_opaque_set_sim_state_c2_test(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_test((SFc2_testInstanceStruct*)chartInfo->chartInstance, st);
}
...
static void mdlSetWorkWidths_c2_test(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3449100666U));
  ssSetChecksum1(S,(4060714062U));
  ssSetChecksum2(S,(413739721U));
  ssSetChecksum3(S,(3290729744U));
