...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1931980048U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2868495273U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3683525051U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1067391698U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("fLk9GvVNY7B7WscXNeTIrD");
...
{
  return "seY3amFc3dmBOb42krlFpvE";
}
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2900786199U));
  ssSetChecksum1(S,(3091474679U));
  ssSetChecksum2(S,(2129416830U));
  ssSetChecksum3(S,(3779759907U));
